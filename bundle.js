...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constant = __webpack_require__(297);

	var _scope = __webpack_require__(298);

	var _enhancedObj = __webpack_require__(299);

	var _arrowfunc = __webpack_require__(300);

	var _extendedParameters = __webpack_require__(301);

	var _templateLiteral = __webpack_require__(302);

	var _destruct = __webpack_require__(303);

	var _account = __webpack_require__(304);

	var _symbol = __webpack_require__(305);

	var _armstrong = __webpack_require__(306);

	var _generator = __webpack_require__(307);

	var _map_set = __webpack_require__(308);

	var _promises = __webpack_require__(309);
	...
	//UserFriends('KITTU','Sneha','Anjali');
	//let l=['kittu','phuge']
	//printCapital(...l);
...
/***/ function(module, exports) {
	...
	function arrowFunc() {
	    ...
	    names.map(function (name) {
	        return newarray.push({ names: name, length: name.length });
	    });
...
/***/ function(module, exports) {
	...
	exports.printCapital = printCapital;
	function UserFriends(username) {
	    ...
	    (_console = console).log.apply(_console, [username].concat(userfriends));
	}

	function printCapital(a, b) {
...
/***/ function(module, exports) {
	...
	function temp() {
	    ...
	    var msg = 'My name is ' + name + ' my laptop model no is ' + modelno + ' at desk no ' + deskno;
...
/***/ function(module, exports) {
	...
	function dest() {
	  ...
	  var _org$add = org.add,
	      city = _org$add.city,
	      pincode = _org$add.pincode;
...
/***/ function(module, exports) {
	...
	function Acc() {
	    ...
	    var SavingAcc = function (_Account) {
	        ...
	        function SavingAcc(id, name, balance, interest) {
	            _classCallCheck(this, SavingAcc);

	            var _this = _possibleConstructorReturn(this, (SavingAcc.__proto__ || Object.getPrototypeOf(SavingAcc)).call(this, id, name, balance));
	    ...
	    var CurrentAcc = function (_Account2) {
	        ...
	        function CurrentAcc(id, name, balance, cash) {
	            _classCallCheck(this, CurrentAcc);

	            var _this2 = _possibleConstructorReturn(this, (CurrentAcc.__proto__ || Object.getPrototypeOf(CurrentAcc)).call(this, id, name, balance));

	            _this2.cash_credit = cash;
	            return _this2;
	        }
	    ...
	    var obj1 = new SavingAcc(201, 'kirti', 50000, 5000);
	    var obj2 = new CurrentAcc(202, 'Anjali', 30000, 10000);
	    var obj3 = new SavingAcc(203, 'kirti', 50000, 5000);
	    ...
	    var total = 0;
	    total = arr.map(function (obj) {
	        return obj.getBalance();
	    }).reduce(function (sum1, sum2) {
...
/***/ function(module, exports) {
	...
	var prev = Symbol("prev1");
	var curr = Symbol("curr1");

	var fibo = function () {
	  function fibo(previous, current) {
	  ...
	  _createClass(fibo, [{
	    ...
	    value: function value() {
	      var PrevNo = this[prev];
	      var CurrentNo = this[curr];
	      return {
	        next: function next() {
	          var _ref = [CurrentNo, PrevNo + CurrentNo];
	          PrevNo = _ref[0];
	          CurrentNo = _ref[1];
...
/***/ function(module, exports) {
	...
	function mapset() {
	    ...
	    var arr = [].concat(_toConsumableArray(chatroom1.keys()));
	    console.log("USERS in ChatRoom 1....");
	    console.log(arr);

	    var arr1 = [].concat(_toConsumableArray(chatroom1.values()));
	    console.log("msgs in ChatRoom 1....");
	    console.log(arr1);

	    var key2 = [].concat(_toConsumableArray(chatroom2.keys()));
	    console.log("USERS in ChatRoom 2....");
	    console.log(key2);

	    var value2 = [].concat(_toConsumableArray(chatroom2.values()));
...
/***/ function(module, exports) {
	...
	exports.promise_demo = promise_demo;
	function promise_demo() {
	    ...
	    var you = new Promise(function (resolve, reject) {
	        resolve(20);
	    });

	    Promise.all([x, you]).then(function (promises) {
	        var sum = 0;
	        promises.forEach(function (text) {
	            sum = sum + text;
	        });
	        console.log(x + you); //Output: bar foo after 2 secs.
	    });
	}
